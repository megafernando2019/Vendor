    ...
    <form className="banner-form-two" onSubmit={(e) => e.preventDefault()}>
      <div className="tg-booking-form-input-group d-flex align-items-center justify-content-between">
        ...
        >
          ...
          <div className={`tg-booking-form-location-list tg-booking-form-destino-list tg-booking-quantity-active ${location ? "tg-list-open" : ""}`}>
        ...
        >
          ...
          >
            <span className="location">
              <Image src="/assets/img/icons/Pasajeros.png" width={30} height={30} alt="Pasajeros" />
            </span>
            <span className="tg-booking-title-value">
              {selectedPassengers || "Pasajeros"}
            </span>
          </div>
          <div className={`tg-booking-form-location-list tg-booking-form-pasajeros-list tg-booking-quantity-active ${passengers ? "tg-list-open" : ""}`}>
            <ul className="scrool-bar scrool-height pr-5">
              {passengerOptions.map((option) => (
                <li
                  key={option.label}
                  className={selectedPassengers === option.label ? "selected" : ""}
        ...
        <div className="tg-booking-form-parent-inner tg-booking-form-field-keyword p-relative">
          ...
          >
            <span className="location">
                <Image src="/assets/img/icons/Buscar.png" width={30} height={30}/>
            </span>
            {keywordEditing ? (
              <input
                ref={keywordInputRef}
