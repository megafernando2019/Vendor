...
const BannerFormTwo = () => {
  ...
  return (
    <form onSubmit={(e) => e.preventDefault()}>
      <div className="tg-booking-form-input-group d-flex align-items-center justify-content-between">
        <div
          ref={locationRef}
        ...
        >
          ...
          >
            ...
            <span className="tg-booking-title-value">Destino</span>
          </div>
          <div
        ...
        >
          <div
            ...
            className={`tg-booking-add-input-field tg-booking-quantity-toggle ${passengers ? "active" : ""} `}
          >
            <span className="tg-booking-title-value">Pasajeros</span>
            <span className="location">
              <svg
                width="13"
                height="16"
          ...
          <div
            className={`tg-booking-form-location-list tg-booking-quantity-active ${passengers ? "tg-list-open" : ""}`}
          >
            <ul className="scrool-bar scrool-height pr-5">
              <li>
                <i className="fa-regular fa-location-dot"></i>
        ...
        >
          <div
            ...
            className={`tg-booking-add-input-field tg-booking-quantity-toggle ${guest ? "active" : ""}`}
          >
            <span className="location">
              <svg
                width="16"
            ...
            <span className="tg-booking-title-value">Palabre clave</span>
          </div>
          <div
            className={`tg-booking-form-location-list tg-quantity tg-booking-quantity-active ${guest ? "tg-list-open" : ""}`}
          >
            <ul>
