...
const Cta = () => {
   return (
      <div className="tg-banner-area tg-banner-5-space fix  include-bg" style={{ backgroundImage: `url(/assets/img/banner/banner-5/banner-5.webp)` }}>
                     ...
                     <h2 className="tg-banner-5-title mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration="1s">
                        <span className="p-relative">Let’s Discover
                           <svg className="svgs d-none d-lg-block" width="483" height="35" viewBox="0 0 483 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M3.25 22.90C37.75 19.40 126.866 25.90 161.5 25.90C278.5 25.90 398.5 48.40 479.5 3.40" stroke="white" strokeWidth="6" strokeLinecap="round" />
                           </svg>
                        </span>
