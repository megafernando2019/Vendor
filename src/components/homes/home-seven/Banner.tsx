...
const Banner = () => {
   return (
      <div className="tg-hero-area tg-hero-5-spacing z-index-1 p-relative include-bg" style={{ backgroundImage: `url(/assets/img/hero/hero-5/bg.webp)` }}>
                     ...
                     <h4 className="tg-hero-3-subtitle mb-15">Explore Restaurants
                        <span className="tg-hero-5-title-shape">
                           <svg width="262" height="15" viewBox="0 0 262 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M1 9.73L89.33 5L70.87 13L123.764 5L118.774 13L178.159 5V13L261 1" stroke="white" strokeWidth="2" strokeLinecap="round" />
                           </svg>
                        </span>
                     </h4>
