         ...
         <div className="tg-filter-booking-form">
            ...
            <div className="tg-booking-form-parent-inner mb-5">
               ...
               <div className="tg-booking-add-input-date p-relative">
                  <input aria-label="dd/mm/yyyy" className="input" name="datetime-local" type="text" placeholder="dd/mm/yyyy" />
                  <span>
                     <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.77 0.78V3.27M4.23 0.78V3.27M0.78 5.76H13.22M2.16 2.02H11.84C12.60 2.02 13.22 2.58 13.22 3.27V11.98C13.22 12.67 12.60 13.22 11.84 13.22H2.16C1.40 13.22 0.78 12.67 0.78 11.98V3.27C0.78 2.58 1.40 2.02 2.16 2.02Z" stroke="#737374" strokeWidth="0.977778" strokeLinecap="round" strokeLinejoin="round" />
                     </svg>
                  </span>
               </div>
            </div>
                  ...
                  <ul>
                     <li>
                        ...
                        <div className="tg-booking-quantity-item">
                           ...
                           <input className="tg-quantity-input" type="text" defaultValue="1" aria-label="Rooms count" />
                     ...
                     <li>
                        ...
                        <div className="tg-booking-quantity-item">
                           ...
                           <input className="tg-quantity-input" type="text" defaultValue="1" aria-label="Adults count" />
                           <span className="decrement">
                              <svg width="14" height="2" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M1 1H13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                     ...
                     <li>
                        ...
                        <div className="tg-booking-quantity-item">
                           ...
                           <input className="tg-quantity-input" type="text" defaultValue="0" aria-label="Children count" />
                           <span className="decrement">
                              <svg width="14" height="2" viewBox="0 0 14 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M1 1H13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
