      ...
      <form onSubmit={preventNativeFormSubmit}>
         <div className="row">
            <div className="col-lg-12 mb-25">
               <input className="input" type="text" placeholder="Enter your username" aria-label="Enter your username" />
            </div>
            <div className="col-lg-12 mb-25">
               <input className="input" type="email" placeholder="Enter your email" aria-label="Enter your email" />
            </div>
            <div className="col-lg-12 mb-25">
               <input className="input" type="text" placeholder="Password" aria-label="Password" />
            </div>
            <div className="col-lg-12 mb-25">
               <input className="input" type="text" placeholder="Confirm Password" aria-label="Confirm Password" />
            </div>
